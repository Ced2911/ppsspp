...
static const CommandTableEntry commandTable[] = {
	...
	{ GE_CMD_FOGCOLOR, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_FogColor },
	{ GE_CMD_FOG1, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_FogCoef },
	{ GE_CMD_FOG2, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_FogCoef },
	...
	{ GE_CMD_TEXLEVEL, FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_TexLevel },
	...
	{ GE_CMD_AMBIENTCOLOR, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_Ambient },
	{ GE_CMD_AMBIENTALPHA, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_Ambient },
	{ GE_CMD_MATERIALDIFFUSE, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_MaterialDiffuse },
	{ GE_CMD_MATERIALEMISSIVE, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_MaterialEmissive },
	{ GE_CMD_MATERIALAMBIENT, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_MaterialAmbient },
	{ GE_CMD_MATERIALALPHA, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_MaterialAmbient },
	{ GE_CMD_MATERIALSPECULAR, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_MaterialSpecular },
	{ GE_CMD_MATERIALSPECULARCOEF, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, &DIRECTX9_GPU::Execute_MaterialSpecular },
	...
	{ GE_CMD_PRIM, FLAG_EXECUTE, &DIRECTX9_GPU::Execute_Prim },
	...
	{ GE_CMD_TRANSFERSTART, FLAG_FLUSHBEFORE | FLAG_EXECUTE | FLAG_READS_PC, &DIRECTX9_GPU::Execute_BlockTransferStart },
...
DIRECTX9_GPU::DIRECTX9_GPU()
	...
	for (size_t i = 0; i < ARRAY_SIZE(commandTable); i++) {
		...
		if (!cmdInfo_[cmd].func) {
			cmdInfo_[cmd].func = &DIRECTX9_GPU::ExecuteOpInternal;
		}
	}
...
void DIRECTX9_GPU::Execute_BlockTransferStart(u32 op, u32 diff) {
...
bool DIRECTX9_GPU::DescribeCodePtr(const u8 *ptr, std::string &name) {
